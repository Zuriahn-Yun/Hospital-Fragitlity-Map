  ...
  return (
    <div className="relative h-full w-full">
          ...
          >
            <Popup>
              <div style={{ minWidth: '240px', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
                <div style={{ fontSize: '16px', fontWeight: 700, marginBottom: '4px', color: '#1a2332' }}>
                  {hospital.name}
                </div>
                <div style={{ fontSize: '12px', color: '#176B87', marginBottom: '14px' }}>
                  {hospital.city}, Washington
                </div>
                <div style={{ display: 'grid', gap: '8px', fontSize: '13px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0', borderBottom: '1px solid #B4D4FF' }}>
                    <span style={{ color: '#4a5568' }}>Fragility Score</span>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0', borderBottom: '1px solid #B4D4FF' }}>
                    ...
                    <span style={{ fontWeight: 600, color: '#1a2332' }}>{formatNumber(hospital.totalBeds)}</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0', borderBottom: '1px solid #B4D4FF' }}>
                    <span style={{ color: '#4a5568' }}>Occupancy</span>
                    <span style={{ fontWeight: 600, color: '#1a2332' }}>{(hospital.occupancyRate * 100).toFixed(0)}%</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', padding: '6px 0' }}>
                    <span style={{ color: '#4a5568' }}>Risk Level</span>
                    <span
                      style={{
                        fontWeight: 600,
                ...
                <button
                  ...
                  onMouseEnter={(e) => e.currentTarget.style.background = '#0d4a5e'}
      ...
      <div
        ...
        style={{ backgroundColor: '#B4D4FF', border: '2px solid #86B6F6', boxShadow: '0 4px 20px rgba(23, 107, 135, 0.15)' }}
      >
        <div className="mb-3 text-sm font-bold" style={{ color: '#176B87' }}>
        ...
        <div className="flex rounded-lg overflow-hidden">
          ...
          <div className="h-5 w-10" style={{ background: '#dc2626' }} />
          <div className="h-5 w-10" style={{ background: '#7f1d1d' }} />
        </div>
        <div className="mt-2 flex justify-between text-xs" style={{ color: '#4a5568' }}>
          <span>Low</span>
          <span>High</span>
        </div>
        <div className="mt-4 pt-4" style={{ borderTop: '1px solid #86B6F6' }}>
          <div className="text-xs font-semibold mb-3" style={{ color: '#176B87' }}>Marker Size = Beds</div>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs" style={{ color: '#4a5568' }}>200+</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-5 w-5 rounded-full" style={{ backgroundColor: '#86B6F6' }} />
              <span className="text-xs" style={{ color: '#4a5568' }}>500+</span>
            </div>
          </div>
        </div>
      </div>
